    ...
    >
      ...
      <form 
       ...
       className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        {state !== 'Login' && <div className='flex items-center gap-2 border px-6 py-2 rounded-full mt-5'>
          ...
          <div className='flex items-center gap-2 border px-6 py-2 rounded-full mt-4'>
